...
int main( int argc, char* argv[] ) {
	...
	TaskFactory::registerTaskRunner<TofPicoSplitter>( "TofPicoSplitter" );
	TaskFactory::registerTaskRunner<TofCalibrationMaker>( "TofCalibrationMaker" );
